...
<div class="formControls col-xs-8 col-sm-9">
<input type="password" class="input-text"  placeholder="请输入新密码" id="password2" name="password2">
</div>
</div>
 <div class="row cl"  id="nameParentDiv" style="margin-top:20px;margin-left:20px;" > 	<label class="form-label col-xs-4 col-sm-2">新密码
</label>
<div class="formControls col-xs-8 col-sm-9">
<input type="password" class="input-text"  placeholder="请再次输入新密码" id="password3" name="password3">
</div>
</div>
</div>
</form>
...
<div class="page-container">
		<div class="row cl" style="margin-top:20px;">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="alterPassword();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 保存并提交</button>
			</div>
		</div>
</div>
<!--_footer 作为公共模版分离出去-->
...
var password3 = $("#password3").val();
	$.ajax({
	    type: 'post',
	    dataType : "json",
	    url: '${pageContext.request.contextPath}/commonapi/alterPassword/submit.do',
	    data:{
	    	"password1":password1,
	    	"password2":password2,
	    	"password3":password3
