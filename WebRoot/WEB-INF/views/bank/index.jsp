...
<dd style="display: block;"> 
 <ul>
 <li>
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/bank/schoolInfo.do" data-title="学校管理" title="学校管理"> 
学校管理
</a>
</li> 
</ul>
...
<dd style="display: block;"> 
 <ul>
 <li>
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/bank/studentInfo.do" data-title="学生管理" title="学生管理"> 
学生管理
</a>
</li> 
</ul>
...
<dd style="display: block;"> 
 <ul>
 <li>
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/bank/loadApplyInfo.do?1=1&schoolCheckStatus=2" data-title="贷款管理" title="贷款管理"> 
贷款管理
</a>
</li> 
</ul>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="学校管理" data-href="${pageContext.request.contextPath}/bank/schoolInfo.do">学校管理</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" id="iframeDom" frameborder="0" src="${pageContext.request.contextPath}/bank/schoolInfo.do"></iframe>
	</div>
</div>
</section>
