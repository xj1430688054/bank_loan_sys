...
<div class="page-container">
		 <c:if test="${model=='新增' or model=='修改'}">
 <div class="row cl"  id="nameParentDiv" style="margin-top:20px;margin-left:20px;" > 	<label class="form-label col-xs-4 col-sm-2"> 	 <span class="c-red">*</span>
登录名
</label>
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text" value="${data.name}" placeholder="请输入登录名" id="name" name="name">
</div>
</div>
</c:if>
<c:if test="${model=='新增' or model=='修改'}">
 <div class="row cl"  id="passWordParentDiv" style="margin-top:20px;margin-left:20px;" > 	<label class="form-label col-xs-4 col-sm-2"> 	 <span class="c-red">*</span>
登录密码
</label>
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text" value="${data.passWord}" placeholder="请输入登录密码" id="passWord" name="passWord">
</div>
</div>
</c:if>
...
param.passWord=(passWord==undefined?'':passWord);
	...
	$.ajax({
	    ...
	    dataType : "json",
	    url: '${pageContext.request.contextPath}/bank/schoolInfo/save.do?'+hrefParam,
