...
<dd style="display: block;"> 
 <ul>
 <li>
  <a   href="javascript:void(0)" data-href="${pageContext.request.contextPath}/school/loadApplyInfo.do?1=1&scoolId=${user.id}" data-title="学生贷款管理" title="学生贷款管理"> 
学生贷款管理
</a>
</li> 
</ul>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="学生贷款管理" data-href="${pageContext.request.contextPath}/school/loadApplyInfo.do?1=1&scoolId=${user.id}">学生贷款管理</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" id="iframeDom" frameborder="0" src="${pageContext.request.contextPath}/school/loadApplyInfo.do?1=1&scoolId=${user.id}"></iframe>
	</div>
</div>
</section>
