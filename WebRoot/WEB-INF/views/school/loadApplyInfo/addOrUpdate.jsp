...
<div class="page-container">
		 <c:if test="${model=='审核'}">
 <div class="row cl" id="schoolCheckStatusParentDiv" style="margin-top:20px;margin-left:20px;" > 	<label class="form-label col-xs-4 col-sm-2">学校审核状态
</label>
<div class="formControls col-xs-8 col-sm-9">
 <span class="select-box" style="width:200px;">
<select name="schoolCheckStatus" id="schoolCheckStatus" class="select">
 <c:forEach items="${schoolCheckStatusList}" var="opt">
  <c:if test="${opt.id==data.schoolCheckStatus}">
...
<c:if test="${model=='审核'}">
 <div class="row cl"  id="schoolCheckRemarkParentDiv" style="margin-top:20px;margin-left:20px;" > 	<label class="form-label col-xs-4 col-sm-2">学校审核备注
</label>
<div class="formControls col-xs-8 col-sm-9">
<input type="text" class="input-text" value="${data.schoolCheckRemark}" placeholder="请输入学校审核备注" id="schoolCheckRemark" name="schoolCheckRemark">
</div>
</div>
</c:if>
...
var schoolCheckStatus = $("#schoolCheckStatus").val();
param.schoolCheckStatus=(schoolCheckStatus==undefined?'':schoolCheckStatus);
var schoolCheckRemark = $("#schoolCheckRemark").val();
param.schoolCheckRemark=(schoolCheckRemark==undefined?'':schoolCheckRemark);
	...
	$.ajax({
	    ...
	    dataType : "json",
	    url: '${pageContext.request.contextPath}/school/loadApplyInfo/save.do?'+hrefParam,
