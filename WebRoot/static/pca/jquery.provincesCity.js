...
$.fn.ProvinceCity = function(pId,cId,cId2){
	...
	//插入3个空的下拉框
	_self.append("<select style='margin-left:10px; width:100px;height:30px' id='"+pId+"'></select>");
	_self.append("<select style='margin-left:10px; width:100px;height:30px' id='"+cId+"'></select>");
	_self.append("<select style='margin-left:10px; width:100px;height:30px' id='"+cId2+"'></select>");
	//分别获取3个下拉框
